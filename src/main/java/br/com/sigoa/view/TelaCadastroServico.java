...
public class TelaCadastroServico extends JFrame {
	...
	public TelaCadastroServico() throws ParseException {
		...
		JFormattedTextField frt_Valor = new JFormattedTextField(new MaskFormatter("#.###,##"));
		frt_Valor.setFont(new Font("Tahoma", Font.PLAIN, 14));
		frt_Valor.setColumns(10);
		
		JButton btn_Salvar = new JButton("Salvar");
		btn_Salvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Servico servico = new Servico(txt_Nome.getText(), Double.parseDouble(frt_Valor.getText()));
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addComponent(frt_Valor, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE))
							.addGroup(gl_contentPane.createSequentialGroup()
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(frt_Valor, GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
					.addGap(28)
